 ...
 */
function mmg8_cog_form_system_theme_settings_alter(&$form, FormStateInterface &$form_state, $form_id = NULL) {
  ...
  $form['mmg8_cog_example'] = [
  '#type'          => 'checkbox',
  '#title'         => t('mmg8_cog sample setting'),
  '#default_value' => theme_get_setting('mmg8_cog_example'),
